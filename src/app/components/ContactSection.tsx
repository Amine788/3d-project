      ...
      >
        ...
        <div className="space-y-3">
          ...
          >
            ...
            <div>
              <p className="text-sm text-white font-medium">📍 Voir sur Apple Maps</p>
              <p className="text-xs text-amber-400/80 mt-1">R3 Diar Es Soltane, Boumerdès</p>
          ...
          <div className="flex items-center gap-3">
            ...
            <p className="text-sm text-white">HBA REALTIES</p>
          </div>
          <div className="flex items-center gap-3">
